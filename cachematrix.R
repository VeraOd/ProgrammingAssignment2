...
## So if one needs to find the inverse matrix again it won't take a lot of time.

## makeCacheMatrix needs a matrix as input. The output is a list of functions that: 
...
## If it was, then the the result is taken from cache. If it wasn't, then the result is saved in cache.
